      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
        <div class="max-w-xl mx-auto text-center">
          <div class="inline-flex px-4 py-1.5 mx-auto rounded-full">
            <p class="text-4xl font-semibold tracking-widest text-g uppercase">Leo Inc. HR</p>
...
const pages = ref([
  {
    ...
    description: 'Manages Employee Information and maintains their contact information.'
  },
  {
    title: 'Hiring',
    url: '/verifier/verify',
    description: 'Verifies the authenticity of the credentials of the applicants.'
  },
]);
</script>
