                  ...
                  <Menu as="div" class="relative ml-3">
                    <div>
                      <MenuButton class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                        ...
                        <img class="w-12 rounded-full" :src="user.imageUrl" alt="" />
                      </MenuButton>
                    </div>
...
const navigation = [
  { name: 'Home', href: '/issuer', current: route.name === 'issuer-home' },
  { name: 'certification', href: '/issuer/certification', current: route.name === 'issuer-certs' },
  { name: 'Students', href: '/issuer/students', current: route.name === 'issuer-students' },
  { name: 'Issuance', href: '/issuer/issue', current: route.name === 'issuer-issue' },
]
